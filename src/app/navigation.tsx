...
export default async function Navigation() {
	...
	return (
		<nav className="sticky top-0 flex items-center justify-between max-w-6xl px-6 py-2 mx-auto">
			<PrismicNextLink className="text-4xl font-bold" field={nav.data.home_navigation}>B100g</PrismicNextLink>
			<ul className="flex items-center gap-6">
				...
				<li className="px-3 py-1 text-black bg-white rounded">
					<PrismicNextLink field={nav.data.button_link}>
